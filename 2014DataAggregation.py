...
# Data for the 2014 NASCAR Sprint Cup Series Race
race_data = [
...
with open('nascar_2014_race_data.csv', 'w', newline='') as file:
    writer = csv.writer(file)
    writer.writerow(header)
    writer.writerows(race_data)

print("Data has been written to nascar_2014_race_data.csv")